...
const CriteriaRow = ({ item }) => {
  return (
    <li className="flex items-start gap-6 rounded-2xl bg-white/4 backdrop-blur-md p-6 transition-transform duration-200 hover:-translate-y-1">
      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-white/8 bg-transparent text-lg font-bold text-white/95">
        {item.marks}
      </div>
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm font-semibold text-white/70">{item.marks}%</span>
      </div>
    ...
    <section className="w-full px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 text-center">
          <p className="text-[10px] font-medium uppercase tracking-[0.45em] text-white/35">Judging Process</p>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-[10px] text-white/65 sm:text-xs">
            A clear judging rubric to keep scoring transparent, balanced, and easy to follow.
          </p>
        </div>

        <div className="grid gap-8 md:grid-cols-2 md:gap-12">
          <div className="rounded-3xl bg-white/4 backdrop-blur-md p-8 shadow-md">
            <div className="mb-6 flex items-center justify-between">
              <h3 className="text-lg font-semibold text-white">Evaluation Criteria</h3>
              <div className="text-sm font-semibold text-white/70">100</div>
            </div>
          ...
          <div className="rounded-3xl bg-white/4 backdrop-blur-md p-8 shadow-md">
            <div className="mb-6 flex items-center justify-between">
              <h3 className="text-lg font-semibold text-white">Mark Distribution</h3>
              <div className="text-sm font-semibold text-white/70">Weighting</div>
            </div>
            ...
            <div className="mt-6 rounded-2xl bg-black/20 p-4 text-white/70">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs uppercase tracking-wide text-white/40">Total</p>
                  <p className="mt-1 text-lg font-semibold text-white">100 Marks</p>
                </div>
