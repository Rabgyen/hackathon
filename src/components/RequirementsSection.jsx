...
const CheckItem = ({ children }) => {
  return (
    <li className="flex items-start gap-3 sm:gap-4">
      <span className="mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-emerald-400/20 bg-emerald-400/10 text-emerald-300 shadow-[0_0_0_1px_rgba(16,185,129,0.08)]">
