    ...
    <section className='w-full px-4 py-16 text-slate-800 sm:px-6 sm:py-20 lg:px-8'>
      <div className='mx-auto max-w-7xl'>
        <div className='text-center mb-6'>
          ...
          <h3 className='mt-2 text-2xl font-semibold text-slate-900 sm:text-3xl'>Event Schedule (9 AM — 5 PM)</h3>
        </div>
            ...
            <div className='relative z-10 flex items-start justify-between'>
              {hours.map((h, idx) => (
                <div key={h} className='flex-1 relative flex flex-col items-center group'>
                  ...
                  <div className='mt-20 text-[13px] font-medium text-slate-900 group-hover:text-[#005c8f]'>{h}</div>
        ...
        <div className='sm:hidden space-y-6'>
          {hours.map((h, idx) => (
            <div key={h} className='flex items-start gap-6'>
              ...
              <div>
                <div className='text-sm font-semibold text-slate-900 mb-2'>{h}</div>
