...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function no(e,t,n){let r=new Float32Array(Ha),i=new W(0,1,0);return new Fi({name:`SphericalGaussianBlur`,defines:{n:Ha,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function X(){return new Fi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:io(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(){return new Fi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:io(),fragmentShader:`
	...
	`}var ao=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;class re{constructor(e){this.props=e||{},this.uniforms=this.props.material?.uniforms,this.scene=null,this.camera=null,this.material=null,this.geometry=null,this.plane=null}init(){this.scene=new Pn,this.camera=new ia,this.uniforms&&(this.material=new Ii(this.props.material),this.geometry=new q(2,2),this.plane=new Zr(this.geometry,this.material),this.scene.add(this.plane))}update(){A.renderer.setRenderTarget(this.props.output||null),A.renderer.render(this.scene,this.camera),A.renderer.setRenderTarget(null)}}class ie extends re{constructor(e){super({material:{vertexShader:N,fragmentShader:P,uniforms:{boundarySpace:{value:e.cellScale},px:{value:e.cellScale},fboSize:{value:e.fboSize},velocity:{value:e.src.texture},dt:{value:e.dt},isBFECC:{value:!0}}},output:e.dst}),this.uniforms=this.props.material.uniforms,this.init()}init(){super.init(),this.createBoundary()}createBoundary(){let e=new Or,t=new Float32Array([-1,-1,0,-1,1,0,-1,1,0,1,1,0,1,1,0,1,-1,0,1,-1,0,-1,-1,0]);e.setAttribute(`position`,new pr(t,3));let n=new Ii({vertexShader:`
  attribute vec3 position;
  uniform vec2 px;
  precision highp float;
  varying vec2 uv;
...
`,fragmentShader:P,uniforms:this.uniforms});this.line=new xi(e,n),this.scene.add(this.line)}update({dt:e,isBounce:t,BFECC:n}){this.uniforms.dt.value=e,this.line.visible=t,this.uniforms.isBFECC.value=n,super.update()}}class ae extends re{constructor(e){super({output:e.dst}),this.init(e)}init(e){super.init();let t=new q(1,1),n=new Ii({vertexShader:`
    precision highp float;
    attribute vec3 position;
    attribute vec2 uv;
    uniform vec2 center;
...
`,blending:2,depthWrite:!1,uniforms:{px:{value:e.cellScale},force:{value:new U(0,0)},center:{value:new U(0,0)},scale:{value:new U(e.cursor_size,e.cursor_size)}}});this.mouse=new Zr(t,n),this.scene.add(this.mouse)}update(e){let t=ee.diff.x/2*e.mouse_force,n=ee.diff.y/2*e.mouse_force,r=e.cursor_size*e.cellScale.x,i=e.cursor_size*e.cellScale.y,a=Math.min(Math.max(ee.coords.x,-1+r+e.cellScale.x*2),1-r-e.cellScale.x*2),o=Math.min(Math.max(ee.coords.y,-1+i+e.cellScale.y*2),1-i-e.cellScale.y*2),s=this.mouse.material.uniforms;s.force.value.set(t,n),s.center.value.set(a,o),s.scale.value.set(e.cursor_size,e.cursor_size),super.update()}}class oe extends re{constructor(e){super({material:{vertexShader:N,fragmentShader:`
    precision highp float;
    uniform sampler2D velocity;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},velocity:{value:e.src.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e}){this.uniforms.velocity.value=e.texture,super.update()}}class ce extends re{constructor(e){super({material:{vertexShader:N,fragmentShader:`
    precision highp float;
...
`,uniforms:{boundarySpace:{value:e.boundarySpace},pressure:{value:e.src_p.texture},velocity:{value:e.src_v.texture},px:{value:e.cellScale},dt:{value:e.dt}}},output:e.dst}),this.init()}update({vel:e,pressure:t}){this.uniforms.velocity.value=e.texture,this.uniforms.pressure.value=t.texture,super.update()}}class ue{constructor(e){this.options={iterations_poisson:32,iterations_viscous:32,mouse_force:20,resolution:.5,cursor_size:100,viscous:30,isBounce:!1,dt:.014,isViscous:!1,BFECC:!0,...e},this.fbos={vel_0:null,vel_1:null,vel_viscous0:null,vel_viscous1:null,div:null,pressure_0:null,pressure_1:null},this.fboSize=new U,this.cellScale=new U,this.boundarySpace=new U,this.init()}init(){this.calcSize(),this.createAllFBO(),this.createShaderPass()}getFloatType(){return/(iPad|iPhone|iPod)/i.test(navigator.userAgent)?ne:M}createAllFBO(){let e={type:this.getFloatType(),depthBuffer:!1,stencilBuffer:!1,minFilter:T,magFilter:T,wrapS:b,wrapT:b};for(let t in this.fbos)this.fbos[t]=new qt(this.fboSize.x,this.fboSize.y,e)}createShaderPass(){this.advection=new ie({cellScale:this.cellScale,fboSize:this.fboSize,dt:this.options.dt,src:this.fbos.vel_0,dst:this.fbos.vel_1}),this.externalForce=new ae({cellScale:this.cellScale,cursor_size:this.options.cursor_size,dst:this.fbos.vel_1}),this.viscous=new oe({cellScale:this.cellScale,boundarySpace:this.boundarySpace,viscous:this.options.viscous,src:this.fbos.vel_1,dst:this.fbos.vel_viscous1,dst_:this.fbos.vel_viscous0,dt:this.options.dt}),this.divergence=new se({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.vel_viscous0,dst:this.fbos.div,dt:this.options.dt}),this.poisson=new ce({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src:this.fbos.div,dst:this.fbos.pressure_1,dst_:this.fbos.pressure_0}),this.pressure=new le({cellScale:this.cellScale,boundarySpace:this.boundarySpace,src_p:this.fbos.pressure_0,src_v:this.fbos.vel_viscous0,dst:this.fbos.vel_0,dt:this.options.dt})}calcSize(){let e=Math.max(1,Math.round(this.options.resolution*A.width)),t=Math.max(1,Math.round(this.options.resolution*A.height)),n=1/e,r=1/t;this.cellScale.set(n,r),this.fboSize.set(e,t)}resize(){this.calcSize();for(let e in this.fbos)this.fbos[e].setSize(this.fboSize.x,this.fboSize.y)}update(){this.options.isBounce?this.boundarySpace.set(0,0):this.boundarySpace.copy(this.cellScale),this.advection.update({dt:this.options.dt,isBounce:this.options.isBounce,BFECC:this.options.BFECC}),this.externalForce.update({cursor_size:this.options.cursor_size,mouse_force:this.options.mouse_force,cellScale:this.cellScale});let e=this.fbos.vel_1;this.options.isViscous&&(e=this.viscous.update({viscous:this.options.viscous,iterations:this.options.iterations_viscous,dt:this.options.dt})),this.divergence.update({vel:e});let t=this.poisson.update({iterations:this.options.iterations_poisson});this.pressure.update({vel:e,pressure:t})}}class de{constructor(){this.init()}init(){this.simulation=new ue,this.scene=new Pn,this.camera=new ia,this.output=new Zr(new q(2,2),new Ii({vertexShader:N,fragmentShader:`
    precision highp float;
    uniform sampler2D velocity;
...
`,transparent:!0,depthWrite:!1,uniforms:{velocity:{value:this.simulation.fbos.vel_0.texture},boundarySpace:{value:new U},palette:{value:f},bgColor:{value:_}}})),this.scene.add(this.output)}addScene(e){this.scene.add(e)}resize(){this.simulation.resize()}render(){A.renderer.setRenderTarget(null),A.renderer.render(this.scene,this.camera)}update(){this.simulation.update(),this.render()}}class fe{constructor(e){this.props=e,A.init(e.$wrapper),ee.init(e.$wrapper),ee.autoIntensity=e.autoIntensity,ee.takeoverDuration=e.takeoverDuration,this.lastUserInteraction=performance.now(),ee.onInteract=()=>{this.lastUserInteraction=performance.now(),this.autoDriver&&this.autoDriver.forceStop()},this.autoDriver=new te(ee,this,{enabled:e.autoDemo,speed:e.autoSpeed,resumeDelay:e.autoResumeDelay,rampDuration:e.autoRampDuration}),this.init(),this._loop=this.loop.bind(this),this._resize=this.resize.bind(this),window.addEventListener(`resize`,this._resize),this._onVisibility=()=>{document.hidden?this.pause():D.current&&this.start()},document.addEventListener(`visibilitychange`,this._onVisibility),this.running=!1}init(){this.props.$wrapper.prepend(A.renderer.domElement),this.output=new de}resize(){A.resize(),this.output.resize()}render(){this.autoDriver&&this.autoDriver.update(),ee.update(),A.update(),this.output.update()}loop(){this.running&&(this.render(),w.current=requestAnimationFrame(this._loop))}start(){this.running||(this.running=!0,this._loop())}pause(){this.running=!1,w.current&&=(cancelAnimationFrame(w.current),null)}dispose(){try{if(window.removeEventListener(`resize`,this._resize),document.removeEventListener(`visibilitychange`,this._onVisibility),ee.dispose(),A.renderer){let e=A.renderer.domElement;e&&e.parentNode&&e.parentNode.removeChild(e),A.renderer.dispose(),A.renderer.forceContextLoss()}}catch{}}}let pe=x.current;pe.style.position=pe.style.position||`relative`,pe.style.overflow=pe.style.overflow||`hidden`;let me=new fe({$wrapper:pe,autoDemo:p,autoSpeed:m,autoIntensity:h,takeoverDuration:g,autoResumeDelay:v,autoRampDuration:y});S.current=me,(()=>{if(!S.current)return;let u=S.current.output?.simulation;if(!u)return;let d=u.options.resolution;Object.assign(u.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),c!==d&&u.resize()})(),me.start();let he=new IntersectionObserver(e=>{let t=e[0],n=t.isIntersecting&&t.intersectionRatio>0;D.current=n,S.current&&(n&&!document.hidden?S.current.start():S.current.pause())},{threshold:[0,.01,.1]});he.observe(pe),E.current=he;let ge=new ResizeObserver(()=>{S.current&&(O.current&&cancelAnimationFrame(O.current),O.current=requestAnimationFrame(()=>{S.current&&S.current.resize()}))});return ge.observe(pe),C.current=ge,()=>{if(w.current&&cancelAnimationFrame(w.current),C.current)try{C.current.disconnect()}catch{}if(E.current)try{E.current.disconnect()}catch{}S.current&&S.current.dispose(),S.current=null}},[s,t,o,l,n,a,i,e,c,r,u,p,m,h,g,v,y]),(0,_.useEffect)(()=>{let u=S.current;if(!u)return;let d=u.output?.simulation;if(!d)return;let f=d.options.resolution;Object.assign(d.options,{mouse_force:e,cursor_size:t,isViscous:n,viscous:r,iterations_viscous:i,iterations_poisson:a,dt:o,BFECC:s,resolution:c,isBounce:l}),u.autoDriver&&(u.autoDriver.enabled=p,u.autoDriver.speed=m,u.autoDriver.resumeDelay=v,u.autoDriver.rampDurationMs=y*1e3,u.autoDriver.mouse&&(u.autoDriver.mouse.autoIntensity=h,u.autoDriver.mouse.takeoverDuration=g)),c!==f&&d.resize()},[e,t,n,r,i,a,o,s,c,l,p,m,h,g,v,y]),(0,Z.jsx)(`div`,{ref:x,className:`w-full h-full relative overflow-hidden pointer-events-none touch-none ${f||``}`,style:d})}var qc=()=>(0,Z.jsxs)(`div`,{className:`relative`,children:[(0,Z.jsx)(`div`,{style:{width:`100%`,height:600,position:`relative`},children:(0,Z.jsx)(Kc,{colors:[`#5227FF`,`#FF9FFC`,`#B497CF`],mouseForce:20,cursorSize:100,isViscous:!0,viscous:30,iterationsViscous:32,iterationsPoisson:32,resolution:.5,isBounce:!1,autoDemo:!0,autoSpeed:.5,autoIntensity:2.2,takeoverDuration:.25,autoResumeDelay:3e3,autoRampDuration:.6,color0:`#5227FF`,color1:`#FF9FFC`,color2:`#B497CF`})}),(0,Z.jsx)(`div`,{className:`pointer-events-none absolute inset-0 flex items-center justify-center px-6 text-center`,children:(0,Z.jsxs)(`div`,{className:`max-w-4xl space-y-4`,children:[(0,Z.jsxs)(`h1`,{className:`text-3xl font-extrabold leading-tight text-white sm:text-4xl md:text-5xl`,children:[(0,Z.jsx)(`span`,{className:`bg-linear-to-r from-sky-300 via-blue-400 to-indigo-400 bg-clip-text text-transparent`,children:`We are`}),` `,`the Hackathon everyone's been`,` `,(0,Z.jsx)(`span`,{className:`bg-linear-to-r from-cyan-300 via-blue-400 to-indigo-500 bg-clip-text text-transparent`,children:`waiting for.`})]}),(0,Z.jsx)(`p`,{className:`mx-auto max-w-2xl text-sm font-medium text-white/75 sm:text-base md:text-lg`,children:`Experience the first edition Uniglobe Hackathon and CodeFest now.`}),(0,Z.jsx)(`a`,{href:`https://forms.gle/Fz9ay18V86axXXx58`,target:`_blank`,rel:`noreferrer`,className:`pointer-events-auto rounded-xl bg-white px-6 py-3 text-sm font-semibold text-black transition hover:bg-white/90 sm:px-7 sm:py-3.5 sm:text-base`,children:`Register now`})]})})]}),Jc=()=>{let[e,t]=(0,_.useState)(!1);return(0,Z.jsx)(`header`,{className:`fixed top-0 left-0 right-0 z-50 px-4 pt-4`,children:(0,Z.jsx)(`div`,{className:`mx-auto w-full max-w-6xl`,children:(0,Z.jsxs)(`nav`,{className:`rounded-2xl border border-white/15 bg-white/5 px-4 py-2.5 backdrop-blur-xl sm:px-6`,children:[(0,Z.jsxs)(`div`,{className:`flex items-center`,children:[(0,Z.jsxs)(`a`,{href:`/`,className:`flex items-center gap-2`,children:[(0,Z.jsx)(`span`,{className:`inline-flex h-7 w-7 items-center justify-center rounded-full border border-white/20 bg-white/10`,children:(0,Z.jsx)(`svg`,{viewBox:`0 0 24 24`,className:`h-4 w-4 text-white`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,children:(0,Z.jsx)(`path`,{d:`M4 12h16M12 4v16M6.3 6.3l11.4 11.4M17.7 6.3L6.3 17.7`})})}),(0,Z.jsx)(`span`,{className:`text-sm font-semibold tracking-wide text-white sm:text-base`,children:`Uniglobe College IT Club`})]}),(0,Z.jsxs)(`div`,{className:`ml-auto hidden items-center gap-7 md:flex`,children:[(0,Z.jsxs)(`ul`,{className:`flex items-center gap-7 text-sm text-white/80`,children:[(0,Z.jsx)(`li`,{children:(0,Z.jsx)(`a`,{href:`#about`,className:`transition hover:text-white`,children:`About`})}),(0,Z.jsx)(`li`,{children:(0,Z.jsx)(`a`,{href:`#contact`,className:`transition hover:text-white`,children:`Contact`})})]}),(0,Z.jsx)(`a`,{href:`https://forms.gle/Fz9ay18V86axXXx58`,target:`_blank`,rel:`noreferrer`,className:`rounded-xl bg-white px-4 py-2 text-sm font-semibold text-black transition hover:bg-white/90`,children:`Register now`})]}),(0,Z.jsx)(`button`,{type:`button`,className:`ml-auto inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/20 text-white md:hidden`,onClick:()=>t(e=>!e),"aria-label":`Toggle navigation menu`,"aria-expanded":e,children:(0,Z.jsx)(`svg`,{viewBox:`0 0 24 24`,className:`h-5 w-5`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,children:e?(0,Z.jsx)(`path`,{d:`M6 6l12 12M18 6L6 18`}):(0,Z.jsx)(`path`,{d:`M4 7h16M4 12h16M4 17h16`})})})]}),e&&(0,Z.jsxs)(`div`,{className:`mt-3 space-y-2 border-t border-white/15 pt-3 md:hidden`,children:[(0,Z.jsx)(`a`,{href:`#about`,className:`block rounded-lg px-3 py-2 text-sm text-white/85 hover:bg-white/10 hover:text-white`,children:`About`}),(0,Z.jsx)(`a`,{href:`#contact`,className:`block rounded-lg px-3 py-2 text-sm text-white/85 hover:bg-white/10 hover:text-white`,children:`Contact`}),(0,Z.jsx)(`a`,{href:`https://forms.gle/Fz9ay18V86axXXx58`,target:`_blank`,rel:`noreferrer`,className:`mt-1 block w-full rounded-lg bg-white px-4 py-2 text-center text-sm font-semibold text-black`,children:`Register now`})]})]})})})},Yc=[{id:1,value:`25`,label:`hackathons`,bg:`https://images.unsplash.com/photo-1520975911459-7f3a3b3f0d53?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=8f5a2f3b2f6b6b3e`},{id:2,value:`500k+`,label:`total active users`,bg:`https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=9b6b8a5f9d2df3b2`},{id:3,value:`$500k`,label:`given away`,bg:`https://images.unsplash.com/photo-1496307042754-b4aa456c4a2d?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=3c2f7f5b1d6a4f9a`},{id:4,value:``,label:``,bg:`https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=6b7eebc5dd9a2b1c`},{id:5,value:``,label:``,bg:`https://images.unsplash.com/photo-1498050108023-c5249f4df085?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=0f4a3d6e4b5c1d2e`}],Xc=()=>(0,Z.jsx)(`div`,{className:`w-full px-8 py-8`,children:(0,Z.jsx)(`div`,{className:`max-w-7xl mx-auto`,children:(0,Z.jsxs)(`div`,{className:`flex flex-col gap-6 md:flex-row md:items-stretch`,children:[(0,Z.jsxs)(`div`,{className:`flex flex-col gap-6 md:w-1/4`,children:[(0,Z.jsxs)(`div`,{className:`rounded-2xl bg-[#0b1220] p-6 flex flex-col justify-center items-start flex-1`,children:[(0,Z.jsx)(`span`,{className:`text-yellow-300 text-3xl sm:text-4xl md:text-5xl font-bold`,children:`15`}),(0,Z.jsx)(`span`,{className:`text-white/75 mt-2 uppercase tracking-wider text-sm sm:text-base`,children:`Colleges`})]}),(0,Z.jsx)(`div`,{className:`rounded-2xl overflow-hidden h-36 md:h-40`,children:(0,Z.jsx)(`img`,{src:Yc[3].bg,alt:`workspace`,className:`w-full h-full object-cover rounded-2xl`})})]}),(0,Z.jsxs)(`div`,{className:`md:w-1/2 grid grid-cols-1 gap-6`,children:[(0,Z.jsx)(`div`,{className:`rounded-2xl overflow-hidden flex-1`,children:(0,Z.jsx)(`img`,{src:Yc[1].bg,alt:`person`,className:`w-full h-full object-cover rounded-2xl`})}),(0,Z.jsxs)(`div`,{className:`grid grid-cols-2 gap-6`,children:[(0,Z.jsx)(`div`,{className:`rounded-2xl overflow-hidden h-40 md:h-40`,children:(0,Z.jsx)(`img`,{src:Yc[2].bg,alt:`small`,className:`w-full h-full object-cover rounded-2xl`})}),(0,Z.jsx)(`div`,{className:`rounded-2xl bg-[#07121a] p-6 flex items-center justify-center h-40 md:h-40`,children:(0,Z.jsxs)(`div`,{className:`text-center`,children:[(0,Z.jsx)(`div`,{className:`text-2xl sm:text-3xl md:text-4xl font-semibold text-indigo-300`,children:`100k+`}),(0,Z.jsx)(`div`,{className:`text-sm text-white/80 mt-1`,children:`Cash Price`})]})})]})]}),(0,Z.jsxs)(`div`,{className:`flex flex-col gap-6 md:w-1/4`,children:[(0,Z.jsx)(`div`,{className:`rounded-2xl overflow-hidden flex-1`,children:(0,Z.jsx)(`img`,{src:Yc[4].bg,alt:`office`,className:`w-full h-full object-cover rounded-2xl`})}),(0,Z.jsx)(`div`,{className:`md:block rounded-2xl bg-[#07121a] p-6 flex items-center justify-center h-28`,children:(0,Z.jsxs)(`div`,{className:`text-center`,children:[(0,Z.jsx)(`div`,{className:`text-2xl md:text-3xl font-semibold text-teal-300`,children:`4`}),(0,Z.jsx)(`div`,{className:`text-sm text-white/80 mt-1`,children:`Judges`})]})})]})]})})}),Zc=[{name:`Alpha`,src:`data:image/svg+xml;base64,`},{name:`Nova`,src:`data:image/svg+xml;base64,`},{name:`Orbit`,src:`data:image/svg+xml;base64,`},{name:`Pulse`,src:`data:image/svg+xml;base64,`},{name:`Zenith`,src:`data:image/svg+xml;base64,`},{name:`Vertex`,src:`data:image/svg+xml;base64,`}],Qc=({sponsor:e})=>(0,Z.jsx)(`div`,{className:`shrink-0 w-45 sm:w-55 md:w-60 lg:w-65`,children:(0,Z.jsx)(`img`,{src:e.src,alt:e.name,className:`h-20 sm:h-24 md:h-28 w-full object-contain select-none`,draggable:`false`})}),$c=()=>(0,Z.jsx)(`section`,{className:`w-full px-4 sm:px-6 lg:px-8 py-16`,children:(0,Z.jsxs)(`div`,{className:`max-w-7xl mx-auto`,children:[(0,Z.jsxs)(`div`,{className:`mb-8 text-center md:text-left`,children:[(0,Z.jsx)(`p`,{className:`text-xs sm:text-sm uppercase tracking-[0.35em] text-white/45`,children:`Partners & Support`}),(0,Z.jsx)(`h2`,{className:`mt-3 text-2xl sm:text-3xl md:text-4xl font-semibold text-white`,children:`Sponsors`})]}),(0,Z.jsxs)(`div`,{className:`relative overflow-hidden rounded-4xl bg-transparent py-6 sm:py-8`,children:[(0,Z.jsx)(`div`,{className:`pointer-events-none absolute inset-y-0 left-0 w-12 sm:w-20 bg-linear-to-r from-[#120f17] to-transparent z-10`}),(0,Z.jsx)(`div`,{className:`pointer-events-none absolute inset-y-0 right-0 w-12 sm:w-20 bg-linear-to-l from-[#120f17] to-transparent z-10`}),(0,Z.jsxs)(`div`,{className:`sponsor-marquee-track flex w-max items-center gap-4 sm:gap-6 px-4`,children:[(0,Z.jsx)(`div`,{className:`flex items-center gap-4 sm:gap-6`,children:Zc.map(e=>(0,Z.jsx)(Qc,{sponsor:e},e.name))}),(0,Z.jsx)(`div`,{className:`flex items-center gap-4 sm:gap-6`,"aria-hidden":`true`,children:Zc.map(e=>(0,Z.jsx)(Qc,{sponsor:e},`${e.name}-clone`))})]})]})]})}),el=[{title:`Winner`,subtitle:`1st place`,value:`Trophy + Rs. 30k`,amountLabel:`Prize amount`,amountValue:`Rs. 30k`,description:`The winning team will be celebrated for the strongest overall solution, presentation, and execution across the event.`,accent:`from-[#FFE08A] via-[#FFB347] to-[#FF7A18]`,ring:`border-[#FFD56A]/20`,bg:`from-[#FFD56A]/15 via-white/5 to-transparent`,orb:`bg-[#FFD56A]/35`,glow:`shadow-[0_30px_90px_rgba(255,196,61,0.18)]`,image:`/College-Hackathon-and-CodeFest/assets/1st-place-BZg9D_JH.png`,imageAlt:`1st place award`},{title:`Runner Up`,subtitle:`2nd place`,value:`Trophy + Rs. 25k`,amountLabel:`Prize amount`,amountValue:`Rs. 25k`,description:`The runner-up team will be recognized for an impressive project, strong teamwork, and a polished final delivery.`,accent:`from-[#F5F5F5] via-[#D4D4D4] to-[#A3A3A3]`,ring:`border-white/20`,bg:`from-white/12 via-white/6 to-transparent`,orb:`bg-white/35`,glow:`shadow-[0_30px_90px_rgba(255,255,255,0.12)]`,image:`/College-Hackathon-and-CodeFest/assets/2nd-place-CntUKkzM.png`,imageAlt:`2nd place award`},{title:`Gift`,subtitle:`Special reward`,value:`Gift hamper`,amountLabel:`Prize amount`,amountValue:`Gift hamper`,description:`Selected teams will receive a special gift reward as a bonus recognition for their effort and creativity.`,accent:`from-[#F7C6FF] via-[#E28CFF] to-[#B85CFF]`,ring:`border-fuchsia-300/20`,bg:`from-fuchsia-300/15 via-white/5 to-transparent`,orb:`bg-fuchsia-300/35`,glow:`shadow-[0_30px_90px_rgba(198,108,255,0.16)]`,image:`/College-Hackathon-and-CodeFest/assets/gift-box-CZCeQWWW.png`,imageAlt:`Gift award`},{title:`Credits`,subtitle:`Participation perk`,value:`Event credits`,amountLabel:`Prize amount`,amountValue:`Event credits`,description:`Participants will also receive credits as part of the event perks, making the experience more rewarding overall.`,accent:`from-[#9BF6FF] via-[#38D9D9] to-[#0EA5E9]`,ring:`border-cyan-300/20`,bg:`from-cyan-300/15 via-white/5 to-transparent`,orb:`bg-cyan-300/35`,glow:`shadow-[0_30px_90px_rgba(56,189,248,0.16)]`,image:`/College-Hackathon-and-CodeFest/assets/increase-CqWnIY6r.png`,imageAlt:`Credits award`}],tl=8e3,nl=()=>{let[e,t]=(0,_.useState)(0),n=el[e];(0,_.useEffect)(()=>{let e=window.setTimeout(()=>{t(e=>(e+1)%el.length)},tl);return()=>window.clearTimeout(e)},[e]);let r=()=>{t(e=>(e-1+el.length)%el.length)},i=()=>{t(e=>(e+1)%el.length)};return(0,Z.jsxs)(`section`,{className:`relative w-full px-4 py-16 sm:px-6 sm:py-20 lg:px-8`,children:[(0,Z.jsxs)(`div`,{className:`pointer-events-none absolute inset-0 -z-10 overflow-hidden`,children:[(0,Z.jsx)(`div`,{className:`absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 rounded-full bg-[#FFD56A]/10 blur-3xl`}),(0,Z.jsx)(`div`,{className:`absolute right-0 top-20 h-80 w-80 rounded-full bg-sky-400/10 blur-3xl`})]}),(0,Z.jsxs)(`div`,{className:`mx-auto max-w-7xl`,children:[(0,Z.jsxs)(`div`,{className:`mb-10 text-center`,children:[(0,Z.jsx)(`p`,{className:`text-xs sm:text-sm uppercase tracking-[0.45em] text-white/40`,children:`Awards`}),(0,Z.jsx)(`h2`,{className:`mt-3 text-2xl font-semibold tracking-tight text-white sm:text-3xl md:text-4xl`,children:`Winner and Runner Up`}),(0,Z.jsx)(`p`,{className:`mx-auto mt-4 max-w-2xl text-sm text-white/65 sm:text-base`,children:`Celebrating Excellence: Honoring Our Winners and Runner-Ups.`})]}),(0,Z.jsxs)(`div`,{className:`group relative overflow-hidden rounded-4xl border ${n.ring} bg-linear-to-br ${n.bg} ${n.glow}`,children:[(0,Z.jsx)(`div`,{className:`absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.16),transparent_26%),radial-gradient(circle_at_bottom_right,rgba(255,255,255,0.08),transparent_30%)]`}),(0,Z.jsx)(`div`,{className:`absolute -right-12 -top-12 h-40 w-40 rounded-full blur-3xl ${n.orb}`}),(0,Z.jsx)(`div`,{className:`absolute -bottom-14 -left-14 h-44 w-44 rounded-full blur-3xl ${n.orb}`}),(0,Z.jsx)(`div`,{className:`overflow-hidden`,children:(0,Z.jsx)(`div`,{className:`flex w-full transition-transform duration-700 ease-in-out`,style:{transform:`translateX(-${e*100}%)`},children:el.map(n=>(0,Z.jsx)(`div`,{className:`w-full shrink-0`,children:(0,Z.jsxs)(`div`,{className:`relative grid gap-8 p-6 sm:p-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:p-10`,children:[(0,Z.jsxs)(`div`,{className:`space-y-6`,children:[(0,Z.jsxs)(`div`,{className:`inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.3em] text-white/70 backdrop-blur`,children:[(0,Z.jsx)(`span`,{className:`h-2 w-2 rounded-full bg-linear-to-r ${n.accent}`}),n.subtitle]}),(0,Z.jsxs)(`div`,{className:`space-y-4`,children:[(0,Z.jsx)(`h3`,{className:`text-3xl font-black tracking-tight text-white sm:text-4xl md:text-5xl`,children:n.title}),(0,Z.jsx)(`p`,{className:`max-w-2xl text-sm leading-7 text-white/70 sm:text-base md:text-lg`,children:n.description})]}),(0,Z.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,Z.jsx)(`button`,{type:`button`,onClick:r,className:`inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white transition hover:-translate-x-0.5 hover:bg-white/15`,"aria-label":`Show previous award`,children:(0,Z.jsx)(`svg`,{viewBox:`0 0 24 24`,className:`h-5 w-5`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,children:(0,Z.jsx)(`path`,{d:`M15 18l-6-6 6-6`})})}),(0,Z.jsx)(`div`,{className:`flex items-center gap-2`,children:el.map((n,r)=>(0,Z.jsx)(`button`,{type:`button`,onClick:()=>t(r),className:`h-2.5 rounded-full transition-all ${r===e?`w-8 bg-white`:`w-2.5 bg-white/30 hover:bg-white/50`}`,"aria-label":`Show ${n.title} award`,"aria-pressed":r===e},n.title))}),(0,Z.jsx)(`button`,{type:`button`,onClick:i,className:`inline-flex h-11 w-11 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white transition hover:translate-x-0.5 hover:bg-white/15`,"aria-label":`Show next award`,children:(0,Z.jsx)(`svg`,{viewBox:`0 0 24 24`,className:`h-5 w-5`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,children:(0,Z.jsx)(`path`,{d:`M9 6l6 6-6 6`})})})]})]}),(0,Z.jsxs)(`div`,{className:`relative flex min-h-70 items-center justify-center rounded-4xl border border-white/10 bg-black/20 p-6 backdrop-blur-xl sm:min-h-85 sm:p-8`,children:[(0,Z.jsx)(`div`,{className:`absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.08),transparent_40%)] opacity-80`}),(0,Z.jsxs)(`div`,{className:`relative flex w-full flex-col items-center gap-6 text-center`,children:[(0,Z.jsx)(`div`,{className:`flex h-24 w-24 items-center justify-center overflow-hidden rounded-full bg-linear-to-br ${n.accent} text-black shadow-2xl shadow-black/25 ring-1 ring-white/25 sm:h-28 sm:w-28`,children:(0,Z.jsx)(`img`,{src:n.image,alt:n.imageAlt,className:`h-16 w-16 object-contain sm:h-20 sm:w-20`})}),(0,Z.jsxs)(`div`,{className:`space-y-2`,children:[(0,Z.jsx)(`p`,{className:`text-xs font-semibold uppercase tracking-[0.4em] text-white/45`,children:n.amountLabel}),(0,Z.jsx)(`p`,{className:`text-3xl font-black tracking-tight text-white sm:text-4xl`,children:n.amountValue})]}),(0,Z.jsxs)(`div`,{className:`w-full max-w-xs rounded-2xl border border-white/10 bg-white/8 px-4 py-3 text-sm text-white/65`,children:[(0,Z.jsx)(`p`,{className:`font-semibold text-white`,children:n.value}),(0,Z.jsx)(`p`,{className:`mt-1`,children:n.subtitle})]})]})]})]})},n.title))})})]})]})]})},rl=[`Projects built using free tools and resources.`,`A complete team with 3 to 4 members.`,`Teams that work collaboratively thorughout both days of the event.`],il=[`Complete descriptions of your project.`,`Proper Documentation of your project.`,`Your slides for presenting your project live.`,`Complete project at the end of the event.`],al=({children:e})=>(0,Z.jsxs)(`li`,{className:`flex items-start gap-3 sm:gap-4`,children:[(0,Z.jsx)(`span`,{className:`mt-1 flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-emerald-400/20 bg-emerald-400/10 text-emerald-300 shadow-[0_0_0_1px_rgba(16,185,129,0.08)]`,children:(0,Z.jsx)(`svg`,{viewBox:`0 0 24 24`,className:`h-4 w-4`,fill:`none`,stroke:`currentColor`,strokeWidth:`2.5`,strokeLinecap:`round`,strokeLinejoin:`round`,"aria-hidden":`true`,children:(0,Z.jsx)(`path`,{d:`M20 6L9 17l-5-5`})})}),(0,Z.jsx)(`span`,{className:`text-xs leading-5 text-white/72 sm:text-sm md:text-base md:leading-6`,children:e})]}),ol=()=>(0,Z.jsx)(`section`,{className:`relative w-full px-4 py-16 sm:px-6 sm:py-20 lg:px-8`,children:(0,Z.jsxs)(`div`,{className:`mx-auto max-w-7xl px-5 py-10 md:px-10 md:py-14`,children:[(0,Z.jsxs)(`div`,{className:`mb-10 text-center`,children:[(0,Z.jsx)(`p`,{className:`text-[10px] font-medium uppercase tracking-[0.45em] text-white/35`,children:`Eligibility & Submission`}),(0,Z.jsx)(`h2`,{className:`mt-3 text-2xl font-semibold tracking-tight text-white sm:text-3xl md:text-4xl`,children:`Requirements`})]}),(0,Z.jsxs)(`div`,{className:`grid gap-10 md:grid-cols-2 md:gap-14`,children:[(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`h3`,{className:`text-lg font-medium text-white/90 sm:text-xl`,children:`What we're looking for:`}),(0,Z.jsx)(`ul`,{className:`mt-6 space-y-5 sm:mt-8 sm:space-y-6`,children:rl.map(e=>(0,Z.jsx)(al,{children:e},e))})]}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`h3`,{className:`text-lg font-medium text-white/90 sm:text-xl`,children:`What you'll need to submit`}),(0,Z.jsx)(`ul`,{className:`mt-6 space-y-5 sm:mt-8 sm:space-y-6`,children:il.map(e=>(0,Z.jsx)(al,{children:e},e))})]})]})]})}),sl=[`9 AM`,`10 AM`,`11 AM`,`12 PM`,`1 PM`,`2 PM`,`3 PM`,`4 PM`,`5 PM`],cl=()=>(0,Z.jsx)(`section`,{className:`w-full px-4 py-16 sm:px-6 sm:py-20 lg:px-8`,children:(0,Z.jsxs)(`div`,{className:`mx-auto max-w-7xl`,children:[(0,Z.jsxs)(`div`,{className:`text-center mb-6`,children:[(0,Z.jsx)(`p`,{className:`text-xs font-medium uppercase tracking-[0.45em] text-white/35`,children:`Schedule`}),(0,Z.jsx)(`h3`,{className:`mt-2 text-2xl font-semibold text-white sm:text-3xl`,children:`Event Schedule (9 AM — 5 PM)`})]}),(0,Z.jsx)(`div`,{className:`hidden sm:block`,children:(0,Z.jsxs)(`div`,{className:`relative mx-auto max-w-6xl py-16 px-4`,children:[(0,Z.jsx)(`div`,{className:`absolute left-4 right-4 top-1/2 transform -translate-y-1/2 h-px bg-white/10 z-0`}),(0,Z.jsx)(`div`,{className:`relative z-10 flex items-start justify-between`,children:sl.map((e,t)=>(0,Z.jsxs)(`div`,{className:`flex-1 relative flex flex-col items-center group`,children:[(0,Z.jsxs)(`div`,{className:`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2`,children:[(0,Z.jsx)(`div`,{className:`h-3 w-3 rounded-full bg-white/90 ring-2 ring-white/10 transform transition duration-300 group-hover:scale-125 group-hover:ring-4 group-hover:ring-[#5227FF]/30`}),(0,Z.jsx)(`div`,{className:`hidden md:block absolute left-1/2 -top-12 -translate-x-1/2 opacity-0 pointer-events-none transition-all duration-200 group-hover:opacity-100 group-hover:-translate-y-2`,children:(0,Z.jsx)(`div`,{className:`whitespace-nowrap rounded-md bg-white/8 px-3 py-1 text-xs text-white/90 backdrop-blur-sm`,children:t===0?`Registration — 9:00`:t===1?`Opening — 10:00`:t===2?`Sessions — 11:00`:t===3?`Lunch — 12:00`:t===4?`Workshops — 13:00`:t===5?`Entertainment — 14:00`:t===6?`Presentations — 15:00`:t===7?`Judging — 16:00`:`Awards — 17:00`})})]}),(0,Z.jsx)(`div`,{className:`mt-20 text-[13px] font-medium text-white group-hover:text-white`,children:e}),(0,Z.jsxs)(`div`,{className:`mt-3 text-xs text-white/60`,children:[t===0&&`Registration`,t===1&&`Opening`,t===2&&`Sessions`,t===3&&`Lunch`,t===4&&`Workshops`,t===5&&`Entertainment`,t===6&&`Presentations`,t===7&&`Judging`,t===8&&`Awards`]})]},e))})]})}),(0,Z.jsx)(`div`,{className:`sm:hidden space-y-6`,children:sl.map((e,t)=>(0,Z.jsxs)(`div`,{className:`flex items-start gap-6`,children:[(0,Z.jsx)(`div`,{className:`mt-2 h-3 w-3 rounded-full bg-white/90 transform transition active:scale-125`}),(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`div`,{className:`text-sm font-semibold text-white mb-2`,children:e}),(0,Z.jsxs)(`div`,{className:`text-xs text-white/60`,children:[t===0&&`Registration`,t===1&&`Opening`,t===2&&`Sessions`,t===3&&`Lunch`,t===4&&`Workshops`,t===5&&`Hacking`,t===6&&`Presentations`,t===7&&`Judging`,t===8&&`Awards`]})]})]},e))})]})}),ll=[{title:`Innovation and Creativity`,description:`How original, creative, and unique the idea is.`,marks:20},{title:`Technical execution`,description:`How well the solution is built, structured, and implemented.`,marks:20},{title:`Problem Identification and Relevance`,description:`How clearly the problem is identified and how relevant it is to real-world needs.`,marks:15},{title:`Feasibility and Practicality`,description:`How realistic, achievable, and practical the proposed solution is.`,marks:15},{title:`UI / UX`,description:`How polished, usable, and visually appealing the experience is.`,marks:10},{title:`Presentation amd Communication`,description:`How clearly the team presents the idea and communicates value.`,marks:10},{title:`Impact & usefulness`,description:`How practical the project is and the problem it solves.`,marks:10}],ul=[{label:`Innovation and Creativity`,marks:20,color:`from-[#8AE6FF] to-[#2E8BFF]`},{label:`Technical execution`,marks:20,color:`from-[#FFE08A] to-[#FF7A18]`},{label:`Problem Identification and Relevance`,marks:15,color:`from-[#A7F3D0] to-[#34D399]`},{label:`Feasibility and Practicality`,marks:15,color:`from-[#FDE68A] to-[#FCA5A5]`},{label:`UI / UX`,marks:10,color:`from-[#F9A8D4] to-[#C084FC]`},{label:`Presentation and Communication`,marks:10,color:`from-[#C4B5FD] to-[#60A5FA]`},{label:`Impact & usefulness`,marks:10,color:`from-[#A7F3D0] to-[#34D399]`}],dl=({item:e})=>(0,Z.jsxs)(`li`,{className:`flex items-start gap-6 rounded-2xl bg-white/4 backdrop-blur-md p-6 transition-transform duration-200 hover:-translate-y-1`,children:[(0,Z.jsx)(`div`,{className:`flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-white/8 bg-transparent text-lg font-bold text-white/95`,children:e.marks}),(0,Z.jsxs)(`div`,{className:`min-w-0`,children:[(0,Z.jsx)(`h3`,{className:`text-base font-semibold text-white leading-tight`,children:e.title}),(0,Z.jsx)(`p`,{className:`mt-2 text-sm text-white/60`,children:e.description})]})]}),fl=({item:e})=>(0,Z.jsxs)(`div`,{className:`space-y-2`,children:[(0,Z.jsxs)(`div`,{className:`flex items-center justify-between`,children:[(0,Z.jsx)(`span`,{className:`text-sm font-medium text-white`,children:e.label}),(0,Z.jsxs)(`span`,{className:`text-sm font-semibold text-white/70`,children:[e.marks,`%`]})]}),(0,Z.jsx)(`div`,{className:`relative h-2 w-full rounded-full bg-white/6 overflow-hidden`,children:(0,Z.jsx)(`div`,{className:`absolute left-0 top-0 h-full rounded-full bg-linear-to-r ${e.color} transition-all`,style:{width:`${e.marks}%`}})})]}),pl=()=>(0,Z.jsx)(`section`,{className:`w-full px-4 py-16 sm:px-6 sm:py-20 lg:px-8`,children:(0,Z.jsxs)(`div`,{className:`mx-auto max-w-7xl`,children:[(0,Z.jsxs)(`div`,{className:`mb-10 text-center`,children:[(0,Z.jsx)(`p`,{className:`text-[10px] font-medium uppercase tracking-[0.45em] text-white/35`,children:`Judging Process`}),(0,Z.jsx)(`h2`,{className:`mt-3 text-2xl font-semibold tracking-tight text-white sm:text-3xl md:text-4xl`,children:`Evaluation Criteria & Mark Distribution`}),(0,Z.jsx)(`p`,{className:`mx-auto mt-4 max-w-2xl text-[10px] text-white/65 sm:text-xs`,children:`A clear judging rubric to keep scoring transparent, balanced, and easy to follow.`})]}),(0,Z.jsxs)(`div`,{className:`grid gap-8 md:grid-cols-2 md:gap-12`,children:[(0,Z.jsxs)(`div`,{className:`rounded-3xl bg-white/4 backdrop-blur-md p-8 shadow-md`,children:[(0,Z.jsxs)(`div`,{className:`mb-6 flex items-center justify-between`,children:[(0,Z.jsx)(`h3`,{className:`text-lg font-semibold text-white`,children:`Evaluation Criteria`}),(0,Z.jsx)(`div`,{className:`text-sm font-semibold text-white/70`,children:`100`})]}),(0,Z.jsx)(`ul`,{className:`space-y-4`,children:ll.map(e=>(0,Z.jsx)(dl,{item:e},e.title))})]}),(0,Z.jsxs)(`div`,{className:`rounded-3xl bg-white/4 backdrop-blur-md p-8 shadow-md`,children:[(0,Z.jsxs)(`div`,{className:`mb-6 flex items-center justify-between`,children:[(0,Z.jsx)(`h3`,{className:`text-lg font-semibold text-white`,children:`Mark Distribution`}),(0,Z.jsx)(`div`,{className:`text-sm font-semibold text-white/70`,children:`Weighting`})]}),(0,Z.jsx)(`div`,{className:`space-y-4`,children:ul.map(e=>(0,Z.jsx)(fl,{item:e},e.label))}),(0,Z.jsx)(`div`,{className:`mt-6 rounded-2xl bg-black/20 p-4 text-white/70`,children:(0,Z.jsxs)(`div`,{className:`flex items-center justify-between`,children:[(0,Z.jsxs)(`div`,{children:[(0,Z.jsx)(`p`,{className:`text-xs uppercase tracking-wide text-white/40`,children:`Total`}),(0,Z.jsx)(`p`,{className:`mt-1 text-lg font-semibold text-white`,children:`100 Marks`})]}),(0,Z.jsx)(`div`,{className:`text-right text-sm text-white/60`,children:`Balanced across idea, build quality, and presentation.`})]})})]})]})]})}),ml=[`https://images.unsplash.com/photo-1515879218367-8466d910aaa4?auto=format&fit=crop&w=1400&q=80`,`https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80`,`https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&w=800&q=80`],hl=()=>(0,Z.jsx)(`section`,{className:`w-full px-4 py-8 sm:px-6 sm:py-10 lg:px-8`,children:(0,Z.jsx)(`div`,{className:`mx-auto max-w-7xl`,children:(0,Z.jsxs)(`div`,{className:`grid gap-4 sm:gap-6 md:grid-cols-3 md:items-stretch`,children:[(0,Z.jsx)(`div`,{className:`md:col-span-2 rounded-2xl overflow-hidden bg-white/5`,children:(0,Z.jsx)(`img`,{src:ml[0],alt:`Event crowd`,loading:`lazy`,className:`w-full h-64 object-cover sm:h-80 md:h-100`})}),(0,Z.jsxs)(`div`,{className:`flex flex-col gap-4`,children:[(0,Z.jsx)(`div`,{className:`rounded-2xl overflow-hidden bg-white/5`,children:(0,Z.jsx)(`img`,{src:ml[1],alt:`Workspace`,loading:`lazy`,className:`w-full h-32 object-cover sm:h-40 md:h-50`})}),(0,Z.jsx)(`div`,{className:`rounded-2xl overflow-hidden bg-white/5`,children:(0,Z.jsx)(`img`,{src:ml[2],alt:`Person on phone`,loading:`lazy`,className:`w-full h-32 object-cover sm:h-40 md:h-50`})})]})]})})}),gl={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},_l=_.createContext&&_.createContext(gl),vl=[`attr`,`size`,`title`];function yl(e,t){if(e==null)return{};var n,r,i=bl(e,t);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);for(r=0;r<a.length;r++)n=a[r],t.indexOf(n)===-1&&{}.propertyIsEnumerable.call(e,n)&&(i[n]=e[n])}return i}function bl(e,t){if(e==null)return{};var n={};for(var r in e)if({}.hasOwnProperty.call(e,r)){if(t.indexOf(r)!==-1)continue;n[r]=e[r]}return n}function xl(){return xl=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)({}).hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},xl.apply(null,arguments)}function Sl(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function Cl(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]==null?{}:arguments[t];t%2?Sl(Object(n),!0).forEach(function(t){wl(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):Sl(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function wl(e,t,n){return(t=Tl(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Tl(e){var t=El(e,`string`);return typeof t==`symbol`?t:t+``}function El(e,t){if(typeof e!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(typeof r!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function Dl(e){return e&&e.map((e,t)=>_.createElement(e.tag,Cl({key:t},e.attr),Dl(e.child)))}function Ol(e){return t=>_.createElement(kl,xl({attr:Cl({},e.attr)},t),Dl(e.child))}function kl(e){var t=t=>{var{attr:n,size:r,title:i}=e,a=yl(e,vl),o=r||t.size||`1em`,s;return t.className&&(s=t.className),e.className&&(s=(s?s+` `:``)+e.className),_.createElement(`svg`,xl({stroke:`currentColor`,fill:`currentColor`,strokeWidth:`0`},t.attr,n,a,{className:s,style:Cl(Cl({color:e.color||t.color},t.style),e.style),height:o,width:o,xmlns:`http://www.w3.org/2000/svg`}),i&&_.createElement(`title`,null,i),e.children)};return _l===void 0?t(gl):_.createElement(_l.Consumer,null,e=>t(e))}function Al(e){return Ol({tag:`svg`,attr:{viewBox:`0 0 24 24`},child:[{tag:`path`,attr:{fill:`none`,d:`M0 0h24v24H0V0z`},child:[]},{tag:`path`,attr:{d:`M6.54 5c.06.89.21 1.76.45 2.59l-1.2 1.2c-.41-1.2-.67-2.47-.76-3.79h1.51m9.86 12.02c.85.24 1.72.39 2.6.45v1.49c-1.32-.09-2.59-.35-3.8-.75l1.2-1.19M7.5 3H4c-.55 0-1 .45-1 1 0 9.39 7.61 17 17 17 .55 0 1-.45 1-1v-3.49c0-.55-.45-1-1-1-1.24 0-2.45-.2-3.57-.57a.84.84 0 0 0-.31-.05c-.26 0-.51.1-.71.29l-2.2 2.2a15.149 15.149 0 0 1-6.59-6.59l2.2-2.2c.28-.28.36-.67.25-1.02A11.36 11.36 0 0 1 8.5 4c0-.55-.45-1-1-1z`},child:[]}]})(e)}function jl(e){return Ol({tag:`svg`,attr:{viewBox:`0 0 24 24`},child:[{tag:`path`,attr:{fill:`none`,d:`M0 0h24v24H0V0z`},child:[]},{tag:`path`,attr:{d:`M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6zm-2 0-8 5-8-5h16zm0 12H4V8l8 5 8-5v10z`},child:[]}]})(e)}function Ml(e){return Ol({tag:`svg`,attr:{version:`1.1`,viewBox:`0 0 17 17`},child:[{tag:`g`,attr:{},child:[]},{tag:`path`,attr:{d:`M8.5 0.5c-3.032 0-5.5 2.467-5.5 5.5 0 4.373 4.913 10.086 5.122 10.328l0.378 0.435 0.378-0.436c0.209-0.241 5.122-5.954 5.122-10.327 0-3.033-2.468-5.5-5.5-5.5zM8.5 15.215c-1.146-1.424-4.5-5.879-4.5-9.215 0-2.481 2.019-4.5 4.5-4.5s4.5 2.019 4.5 4.5c0 3.333-3.354 7.791-4.5 9.215zM8.5 3.139c-1.654 0-3 1.346-3 3s1.346 3 3 3 3-1.346 3-3-1.346-3-3-3zM8.5 8.139c-1.103 0-2-0.897-2-2s0.897-2 2-2 2 0.897 2 2-0.897 2-2 2z`},child:[]}]})(e)}var Nl=[{icon:(0,Z.jsx)(jl,{}),label:`Email`,value:`mail@uniglobe.edu.np | annukhanna@uniglobe.edu.np`,hint:`Use the event inbox for registrations and general questions.`},{icon:(0,Z.jsx)(Al,{}),label:`Phone`,value:`977-1-4115690 | 4115569 | 9851311179`,hint:`Contact us direclty using these numbers.`},{icon:(0,Z.jsx)(Ml,{}),label:`Location`,value:`Uniglobe College`,hint:`New Baneshwor, Kathmandu`}],Pl=()=>(0,Z.jsxs)(`section`,{id:`contact`,className:`relative w-full px-4 py-12 sm:px-6 sm:py-16 lg:px-8`,children:[(0,Z.jsxs)(`div`,{className:`pointer-events-none absolute inset-0 -z-10 overflow-hidden`,children:[(0,Z.jsx)(`div`,{className:`absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 rounded-full bg-[#5227FF]/12 blur-3xl`}),(0,Z.jsx)(`div`,{className:`absolute right-0 top-10 h-80 w-80 rounded-full bg-[#FF9FFC]/10 blur-3xl`}),(0,Z.jsx)(`div`,{className:`absolute bottom-0 left-10 h-56 w-56 rounded-full bg-[#B497CF]/10 blur-3xl`})]}),(0,Z.jsxs)(`div`,{className:`mx-auto max-w-7xl`,children:[(0,Z.jsxs)(`div`,{className:`mx-auto max-w-3xl text-center`,children:[(0,Z.jsx)(`p`,{className:`text-xs font-medium uppercase tracking-[0.45em] text-white/35`,children:`Need Help`}),(0,Z.jsx)(`h2`,{className:`mt-3 text-3xl font-semibold tracking-tight text-white sm:text-4xl md:text-5xl`,children:`Have Confusion?`}),(0,Z.jsx)(`p`,{className:`mx-auto mt-4 max-w-2xl text-sm text-white/65 sm:text-base`,children:`If anything is unclear, reach out using the contact details below and the organizing team will guide you.`})]}),(0,Z.jsx)(`div`,{className:`mt-10 grid gap-5 md:grid-cols-3`,children:Nl.map(e=>(0,Z.jsxs)(`div`,{className:`group relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl transition-transform duration-300 hover:-translate-y-1 hover:bg-white/8`,children:[(0,Z.jsx)(`div`,{className:`absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.08),transparent_40%)] opacity-70`}),(0,Z.jsxs)(`div`,{className:`relative`,children:[(0,Z.jsx)(`div`,{className:`mb-4 inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-black/20 text-xl font-semibold text-white/85`,children:e.icon}),(0,Z.jsx)(`p`,{className:`text-xs font-medium uppercase tracking-[0.35em] text-white/35`,children:e.label}),(0,Z.jsx)(`p`,{className:`mt-2 wrap-break-word text-lg font-semibold text-white`,children:e.value}),(0,Z.jsx)(`p`,{className:`mt-3 text-sm leading-6 text-white/60`,children:e.hint})]})]},e.label))}),(0,Z.jsx)(`div`,{className:`mt-8 px-5 py-4 text-center text-sm text-white/65 backdrop-blur-md sm:px-6`,children:`Clear your confusion by contacting us from the above contact information.`})]})]}),Q=()=>(0,Z.jsx)(`section`,{className:`w-full px-4 py-12 sm:px-6 sm:py-16 lg:px-8 bg-[#0f0c13]`,children:(0,Z.jsx)(`div`,{className:`mx-auto max-w-6xl`,children:(0,Z.jsxs)(`div`,{className:`relative rounded-2xl px-6 py-12 text-center overflow-hidden`,children:[(0,Z.jsx)(`div`,{className:`absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/3 h-40 w-40 rounded-full bg-[#5227FF]/20 blur-3xl`}),(0,Z.jsx)(`div`,{className:`absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/3 h-40 w-40 rounded-full bg-[#FF9FFC]/18 blur-3xl`}),(0,Z.jsxs)(`blockquote`,{className:`mx-auto max-w-3xl text-white`,children:[(0,Z.jsx)(`p`,{className:`text-2xl font-semibold leading-tight sm:text-3xl md:text-4xl`,children:`“It’s fun. It’s simple, and overall, it all about learning new things.”`}),(0,Z.jsx)(`footer`,{className:`mt-4 text-sm text-white/60`,children:`— Developer`})]})]})})});(0,v.createRoot)(document.getElementById(`root`)).render((0,Z.jsx)(_.StrictMode,{children:(0,Z.jsx)(()=>(0,Z.jsxs)(`div`,{className:`bg-[#120f17] min-h-screen w-full`,children:[(0,Z.jsx)(Jc,{}),(0,Z.jsx)(qc,{}),(0,Z.jsxs)(`div`,{className:`text-white`,children:[(0,Z.jsxs)(`div`,{id:`about`,className:`flex scroll-mt-24 flex-col items-center justify-center gap-4 py-8`,children:[(0,Z.jsx)(`h1`,{className:`text-2xl font-semibold sm:text-3xl md:text-4xl`,children:`About the event`}),(0,Z.jsx)(`p`,{className:`max-w-2xl px-4 text-sm font-medium text-white/75 sm:text-base md:text-lg text-center`,children:`The first-ever Code Fest and Hackathon at Uniglobe College will take place on June 28 and 29. The first day features an interactive and exciting Code Fest, while the final day showcases hackathon project presentations, followed by judging and winner announcements.`})]}),(0,Z.jsx)(Xc,{}),(0,Z.jsx)($c,{}),(0,Z.jsx)(nl,{}),(0,Z.jsx)(ol,{}),(0,Z.jsx)(cl,{}),(0,Z.jsx)(pl,{})]}),(0,Z.jsx)(Pl,{}),(0,Z.jsx)(hl,{}),(0,Z.jsx)(Q,{})]}),{})}));